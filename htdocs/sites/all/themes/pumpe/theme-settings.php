...
/**
 * USAGE:
 * 1 - To use this file replace "pumpe" with the name of
...
// Replace 'pumpe' with your themes name, eg:
// function your_themes_name_form_system_theme_settings_alter(&$form, &$form_state)
function pumpe_form_system_theme_settings_alter(&$form, &$form_state)  {
